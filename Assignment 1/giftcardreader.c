...
void animate(char *msg, unsigned char *program) {
    ...
    while (pc < program+256) {
        ...
        switch (*pc) {
            ...
            case 0x01:
                //printf("case1\n");
                if(arg1 > 15 || arg1 < 0) break; //crash2.gft 
                regs[arg1] = *mptr;
                break;
            case 0x02:
                //printf("case2\n");              
            ...
            case 0x03:
                ...
                break;
            case 0x04:
                if(arg1<16 && arg1>=0 && arg2<16 && arg2>=0){ //fuzzer 1 solution
                //printf("case4\n");
                regs[arg2] = arg1;
                //printf("case4.1\n");
                }
                break;
            case 0x05:
                if(arg1<16 && arg1>=0 && arg2<16 && arg2>=0){ // fuzzer 2 solution
                //printf("case5\n");
                regs[arg1] ^= regs[arg2];
                //printf("case5.1\n");
                zf = !regs[arg1];
            ...
            case 0x09:
                //printf("case9\n");
                pc += (unsigned char)arg1; //hang.gft fix 
                //printf("case9.2\n");
                break;
            case 0x10:
                //printf("case10s\n");
...
struct this_gift_card *gift_card_reader(FILE *input_fd) {
	...
	while (!feof(input_fd)) {
       ...
       if(ret_val->num_bytes < 0){
           printf("You have entered a negative value: %d. Please enter the correct size\n", ret_val->num_bytes);
           exit(0);
        }
